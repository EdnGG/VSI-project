...
function threeWay () {
  ...
  let radioButtonsBonnets = document.querySelector('input[name="BonnetsRadioButtons"]:checked').value;
  ...
  let boltHoles = document.querySelector('input[name="boltHoles"]:checked').value;
  let holeSize = document.querySelector('#holeSize').value;
  let other = document.querySelector('#otherBonnet').value;
  let shaftType = document.querySelector('input[name="radioShaft"]:checked').value;
  ...
  let actReqSecc1 = document.querySelector('input[name="seccion10"]:checked').value;
  let actReqSecc2 = document.querySelector('input[name="seccion10.1"]:checked').value;
  let actReqSecc3 = document.querySelector('input[name="seccion10.2"]:checked').value;
  let actReqSecc4 = document.querySelector('input[name="seccion10.3"]:checked').value;
  let otherPneumaticOrElec = document.querySelector('#otherInput10').value;
  let controlSignal = document.querySelector('input[name="seccion10.4"]:checked').value;
  let otherControlSignal = document.querySelector('#otherControlInput10').value;
  let enclosureRequired = document.querySelector('input[name="seccion10.5"]:checked').value;
