...
function hpActuatorPDF(
  ...
  <div class="background--pdf">
        ...
        flex-flow: column wrap;">
          ...
          <strong class="modal-title main-title text-center" id="staticBackdropLabel">Retrofit Form for High Pressure Actuator</strong>
        </div><br >
